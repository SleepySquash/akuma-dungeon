...
enum IntroductionStage { novel, character, name }
...
class IntroductionController extends GetxController {
  ...
  final AudioSource _source = AudioSource.asset(
    'assets/music/MOSAICWAV_she_already_gone.mp3',
  );
  ...
  Future<void> _register() async {
    ...
    router.home(
      player: Player(name: name.text, race: race.value, gender: gender.value),
    );
  }
    ...
    await Novel.show(
      ...
      scenario: [
        ...
        const DialogueLine(
          'Добрый день!',
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/1.mp3'),
        ),
        const DialogueLine(
          'Добро пожаловать в гильдию путешественников города Алоросс!',
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/2.m4a'),
        ),
        const DialogueLine(
          'Я временно заменяю гильдмастера, она... будет позже.',
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/5.m4a'),
        ),
    ...
    await Novel.show(
      ...
      scenario: [
        ...
        const DialogueLine(
          ...
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/31.m4a'),
        ),
        const DialogueLine(
          'Дай мне пару минут...',
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/32.m4a'),
        ),
        ...
        const DialogueLine(
          'Готово!',
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/9.m4a'),
        ),
        const DialogueLine(
          'Ну что, поздравляю, теперь ты настоящий путешественник!',
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/10.m4a'),
        ),
        const DialogueLine(
        ...
        const DialogueLine(
          ...
          by: 'Мастер',
          voice: FromAsset('assets/voice/intro/18.m4a'),
        ),
        HideImageLine.asset('Arda.png'),
        BackgroundLine.asset('location/town.jpg'),
        const DialogueLine(
